...
list_of_files = [
    ...
    "src/{project_name}/components/model/__init__.py",
    "src/{project_name}/components/model/model.py",
    "src/{project_name}/components/model/dataset.py",
    "src/{project_name}/components/model/loss.py",
    "src/{project_name}/components/model/train.py",
    "src/{project_name}/components/model/eval.py",
    "src/{project_name}/components/model/optimizer.py",
    "src/{project_name}/components/model/metrics.py",
    "src/{project_name}/components/model/utils.py",
